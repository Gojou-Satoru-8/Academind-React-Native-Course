...
const AuthForm: React.FC<AuthFormProps> = function ({ isLogin, onSubmit, credentialsInvalid }) {
  ...
  const updateInputValueHandler = function (inputType: keyof Credentials, enteredValue: string) {
    switch (inputType) {
      case "email":
